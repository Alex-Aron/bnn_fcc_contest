...
//
// Joe Modified this with chat gpt to be full when half full and allow writes
// when "full"
// Modified: full = half full, writes allowed when full
...
module fifo #(
  ...
  assign count = wr_addr_r - rd_addr_r;
  ...
  // MODIFIED: allow writes regardless of full
  assign valid_wr = wr_en;

  assign valid_rd = rd_en && !empty;

  // MODIFIED: full now means "half full or more"
